...
export default function SongDisplay() {
  ...
  return (
    <div className='flex flex-col w-full mt-14 md:mt-10'>
      ...
      <h5 className='text-sm font-light text-foreground/90 italic mb-1'>Currently Viewing</h5>
      <svg xmlns="http://www.w3.org/2000/svg" className="w-[60px] mb-1" version="1.1" viewBox="0 0 559 168">
      ...
      <a href={trackData.item.album.external_urls.spotify}>
        <img src={trackData.item.album.images[0].url} alt={`album cover for ${trackData.item.album.name}`} className='w-full rounded-sm border-foreground border-[1.5px] aspect-square object-cover'/>
      </a>
